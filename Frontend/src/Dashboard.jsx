...
<div className="flex items-center justify-between mb-12">
  ...
  <div
    onClick={() => navigate("/")}
    className="flex items-center gap-3 text-2xl font-bold text-red-500 cursor-pointer hover:scale-105 transition"
  >
    <Code2 /> AlgoForge Dashboard
  </div>
  ...
  <div className="flex items-center gap-6">
    ...
    <button
      ...
      className="px-6 py-2 rounded-xl border border-red-500 text-red-500
